...
public class UnigramWordPredictor implements WordPredictor {
  ...
  public String predictNextWord(List<String> context) {
    ...
    if (neighborMap.containsKey(lastWordInContext)) {
      List<String> nextWords = neighborMap.get(lastWordInContext);

      Random rand = new Random();
      int nextWordSize = nextWords.size();
      int randomIndex = rand.nextInt(nextWordSize);
      String predicitedWord = nextWords.get(randomIndex);
      return predicitedWord;
    }
    return null;
  }
